...
import { Users, UserCog, FileClock, Settings as SettingsIcon } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <Link href="/squadra/staff" className="flex items-center gap-3 rounded-xl border bg-card p-4">
          <UserCog className="h-5 w-5 text-primary" />
          <span className="font-medium">Staff tecnico</span>
        </Link>
        <Link
