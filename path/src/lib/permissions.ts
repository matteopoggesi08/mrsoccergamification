...
export const permissionLabels:Record<Permission,string>={players:'Rosa',sessions:'Sedute',attendance:'Presenze',workload:'Carichi',games:'Partitelle',matches:'Partite',leaderboard:'Classifica',fines:'Multe',reports:'Report',members:'Staff'};
